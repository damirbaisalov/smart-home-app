package kz.smart.house.ksk_list.presentation
...
import kz.smart.house.ksk_list.presentation.view.KskItemClickListener
import kz.smart.house.ksk_list.presentation.view.KskListAdapter
...
//            searchView.setBackgroundResource(R.drawable.bg_search_view_off)
    ...
    private fun loadApiData() {
        ApiRetrofit.getApiClient().getKskList("1").enqueue(object : Callback<List<KskApiData>> {
    ...
    private fun getKskItemClickListener(): KskItemClickListener {
        return object : KskItemClickListener {
            override fun onKskClick(id: String?) {
                ...
                intentDetailed.putExtra(
                    "save_button_invisible",
                    intent.getBooleanExtra("clicked_from_open_ksk_list", false)
                )
